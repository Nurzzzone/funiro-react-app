        ...
        <div className="container">
          <div className="home__inner">
            <div className="home__card" data-aos="fade-up">
              <h2 className="home__card-title">High-Quality Furniture Just For You</h2>
              <p className="home__card-subtitle">Our furniture is made from selected and best quality materials that are suitable for your dream home</p>
              <Link className="btn btn-main home__card-btn" to="/products">Shop Now</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="products" data-aos="fade-up">
        <div className="container">
          <div className="products__inner">
            <div className="section__title products-title">
            ...
            <Link 
              to="/products"
              className="btn btn-outline products-btn"
            >Show More</Link>
          </div>
        </div>
      </section>
